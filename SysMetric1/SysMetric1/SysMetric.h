...
#define numlines ((int)sizeof(sysMetric) / sizeof(sysMetric[0]))

struct sysMetricInfo
{
	int iIndex;
	TCHAR *szLabel;
	TCHAR *szDesc;
...
sysMetricInfo sysMetric[] = {   SM_CXSCREEN, TEXT ("SM_CXSCREEN"),TEXT ("Screen width in pixels"),
